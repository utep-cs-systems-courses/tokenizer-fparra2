...
char *copy_str(char *inStr, short len){
    int size = len;
    size = (word_wnd(inStr) - word_start(inStr)); // lenght of word being pointed 
    char* token = (char*) malloc((size+1) * sizeof(char));  // allocates memory of char* w/len of the string 
